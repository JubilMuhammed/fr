...
/* Only affect portfolio image blocks */
.portfolio-fullwidth .large-img img {
    width: 85%;
    max-width: 1200px;
    height: auto;
}

/* Disable grow hover ONLY for portfolio images */
.portfolio-fullwidth .grow,
.portfolio-fullwidth .grow img {
...
/* Remove extra space after portfolio title section */
.portfolio-large-img-and-top-title .title-areas-wrapper-pd {
    padding-bottom: 0 !important;
    margin-bottom: 0 !important;
}

/* Remove gap before blog section */
.portfolio-large-img-and-top-title .rts-blog-area {
    padding-top: 0 !important;
    margin-top: 0 !important;
}

/* Remove row top margin */
.portfolio-large-img-and-top-title .rts-blog-area .row {
    margin-top: 0 !important;
}

/* Optional: fine control if still little gap */
.portfolio-large-img-and-top-title .bottom-area {
    margin-bottom: 0 !important;
}
...
FootballGeek</span>
        ...
        <!-- ===== Blog / Case Studies Section (Original Size) ===== -->
