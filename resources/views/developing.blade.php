    ...
    <div class="portfolio-large-img-and-top-title">
        ...
        <div class="container-140 pb--120">
            <div class="large-img grow">
                <img src="assets/images/develop2.png" alt="product">
            </div>
            <br><br>
            <div class="large-img grow">
                <img src="assets/images/develop.png" alt="product">
            </div>
        </div>
    </div>
...
<!-- portfolio title area and large img area -->
    <div class="portfolio-large-img-and-top-title">
        ...
        <div class="container-140 pb--120">
            <div class="large-img grow">
                <img src="assets/images/j1.jpg" alt="product">
            </div>
            <br><br>
            <div class="large-img grow">
                <img src="assets/images/j2.jpg" alt="product">
            </div>
            <br><br>
            <div class="large-img grow">
                <img src="assets/images/j3.jpg" alt="product">
            </div>
            <br><br>
            <div class="large-img grow">
                <img src="assets/images/j4.jpg" alt="product">
            </div>
            <br><br>
        </div>
    </div>
